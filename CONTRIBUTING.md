...
[open a well-written issue or discussion](https://github.com/ory/label-sync-action/issues):
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Conventional Commits configuration](https://github.com/ory/label-sync-action/blob/master/.github/workflows/conventional_commits.yml)
...
maintain the quality and reliability of Ory Label Sync Action, please follow
these guidelines:
...
git clone git@github.com:ory/label-sync-action.git
