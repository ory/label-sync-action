...
# Contribute to Ory Label Sync Action<!-- omit in toc -->
...
Action, please disclose it by contacting us at security@ory.com.
...
won't clash with Ory Label Sync Action's direction. A great way to do this is
via [Ory Label Sync Action Discussions](https://github.com/orgs/ory/discussions)
...
- **Help with open issues.** We have a lot of open issues for Ory Label Sync
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/ory/label-sync-action/blob/master/.github/workflows/conventional_commits.yml)
