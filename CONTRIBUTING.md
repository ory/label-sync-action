...
# Contributing to Ory Label Sync Action
...
_Please note_: We take Ory Label Sync Action's security and our users' trust
very seriously. If you believe you have found a security issue in Ory Label Sync
Action, please responsibly disclose by contacting us at security@ory.sh.
...
won't clash or be obviated by Ory Label Sync Action's normal direction. A great
way to do this is via
[Ory Label Sync Action Discussions](https://github.com/orgs/ory/discussions) or
the [Ory Chat](https://www.ory.sh/chat).

## FAQ

- I am new to the community. Where can I find the
  [Ory Community Code of Conduct?](https://github.com/ory/label-sync-action/blob/master/CODE_OF_CONDUCT.md)

- I have a question. Where can I get
  [answers to questions regarding Ory Label Sync Action?](#communication)
...
- I want to talk to other Ory Label Sync Action users.
  [How can I become a part of the community?](#communication)

- I would like to know what I am agreeing to when I contribute to Ory Label Sync
  Action. Does Ory have
  [a Contributors License Agreement?](https://cla-assistant.io/ory/label-sync-action)

- I would like updates about new versions of Ory Label Sync Action.
...
[list of good first issues](https://github.com/ory/label-sync-action/labels/good%20first%20issue).
...
- **Give us a star.** It may not seem like much, but it really makes a
  difference. This is something that everyone can do to help out Ory Label Sync
  Action. Github stars help the project gain visibility and stand out.
...
- **Helping with open issues.** We have a lot of open issues for Ory Label Sync
  Action and some of them may lack necessary information, some are duplicates of
...
Check out
[Ory Label Sync Action Discussions](https://github.com/orgs/ory/discussions).
...
If you want to receive regular notifications about updates to Ory Label Sync
Action, consider joining the mailing list. We will _only_ send you vital
...
before getting started to ensure your work is consistent with Ory Label Sync
Action's roadmap and architecture.
...
1. Ensure that each commit has a descriptive prefix. This ensures a uniform
   ...
   [list of prefixes for Label Sync Action](https://github.com/ory/label-sync-action/blob/master/.github/semantic.yml)
   for an overview.
...
[Contributor License Agreement](https://cla-assistant.io/ory/label-sync-action).
...
[docs](https://github.com/ory/label-sync-action/tree/master/docs) folder.
Generate API and configuration reference documentation using
`cd docs; npm run gen`.

For further instructions please head over to
[docs/README.md](https://github.com/ory/label-sync-action/blob/master/README.md).
...
git clone git@github.com:ory/ory/label-sync-action.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/ory/label-sync-action.git
...
- Private harassment is also unacceptable. No matter who you are, if you feel
  ...
  member, please contact one of the channel ops or a member of the Ory Label
  Sync Action core team immediately.
